                ...
                <div className="pt-9 flex flex-row items-center">
                    {
                        token
                        ?
                            <Image src={userInfo?.avatar ?? "/images/user/Loading.svg"} alt="avatar" width={83} height={83} className={"w-20.75 h-20.75 rounded-full stroke-0.25 stroke-[#FFF]"} />
                        :
                            <Image src={"/images/user/NotLoggedIn.svg"}
                                   alt="avatar"
                                   width={83}
                                   height={83}
                                   className={"w-20.75 h-20.75 rounded-full stroke-0.25 stroke-[#FFF]"}
                            ...
                            <li className={"flex flex-col items-center w-1/4 mt-4.5 mb-2.5"}>
                                <Link href="../login" className="flex flex-col items-center">
                                    <Image src={'/images/user/SignOut.svg'} alt={"退出登录"} width={"48"} height={"48"}
                                           className={"w-6 h-6"} />
                                    <p className={"w-11.5 text-[#252525] text-2.75 font-400 lh-6"} onClick={() => logout()}>退出登录</p>
                                </Link>
                            </li>
