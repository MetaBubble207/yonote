...
const LeftCompass = () => {
  ...
  useEffect(() => {
    if (!columnId || columnId === null) {
      if (latestColumnId) {
        console.log("latest =++++>", latestColumnId)
      ...
      <div className="top-17.5 w-65 z-100 fixed h-screen shrink-0 bg-[#FFF]">
        <div className="w-65 h-72.4785 mt-10 flex shrink-0 flex-col">
          ...
          >
            ...
            ></Image>
            <Link
              href={`/writer/content-management?columnId=${columnIdState}`}
              passHref
            >
              <div className="h-6.00625 text-3.5 font-400 lh-6 ml-2.07 mt-2.89 w-14 shrink-0">
                内容管理
          ...
          >
            ...
            ></Image>
            <Link
              href={`/writer/subscribe-manage?columnId=${columnIdState}`}
              passHref
            >
              <div className="h-6.00625 text-3.5 font-400 lh-6 ml-2.07 mt-2.89 w-14 shrink-0">
                订阅管理
          ...
          >
            ...
            ></Image>
            <Link
              href={`/writer/column-settings?columnId=${columnIdState}`}
              passHref
            >
              <div className="h-6.00625 text-3.5 font-400 lh-6 ml-2.07 mt-2.89 w-14 shrink-0">
                专栏设置
          ...
          >
            <Image
              ...
              className="h-6.00625 ml-10.555 mt-2.89 w-6 shrink-0"
            ></Image>
            <Link href={`/writer/co-author?columnId=${columnIdState}`} passHref>
              <div className="h-6.00625 text-3.5 font-400 lh-6 ml-2.07 mt-2.89 w-14 shrink-0">
                共创作者
              </div>
            </Link>
          ...
          >
            <Image
              ...
              className="h-6.00625 ml-10.555 mt-2.89 w-6 shrink-0"
            ></Image>
            <Link href={`/writer/speed-up?columnId=${columnIdState}`} passHref>
              <div className="h-6.00625 text-3.5 font-400 lh-6 ml-2.07 mt-2.89 w-14 shrink-0">
                加速计划
              </div>
            </Link>
