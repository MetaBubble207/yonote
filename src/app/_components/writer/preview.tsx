...
const Preview=({ html })=>{
    ...
    return(
        <div>
            <div className="w-93 h-154.25 shrink-0 fill-#FFF stroke-0.25 stroke-[#D9D9D9] ml-4.5 b-1 b-#d9d9d9">
             
                    <div className="text-[rgba(0,0,0,0.85)] text-5 font-not-italic font-400 lh-5.5 ml-3.725 mt-3.725">标题：</div>
