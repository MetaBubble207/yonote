           ...
           {data?.map(item => (
                <div className="inline mt-4 h-36.25 w-full border-rd-4 bg-[#FFF] flex relative " key={item.id}>
                    <div className="inline mt-2.5 ml-2.5 h-31.25 w-80.75 item-center flex  ">
                        ...
                        <div className={` absolute top-2.5 left-2.5 w-11.75 h-5.25 border-rd-[0px_25px_25px_0px] bg-[#B8BBCC]}`}>
                            <div className="ml-1.75 mt-1 text-[#FFF] text-2.5 font-500 lh-[120%]">进行中</div>
                        </div>
                        <button className={`ml-61 mt-23.5 w-18.25 h-6.25 bg-[rgba(218,249,241,0.35)] border-rd-5.25 text-[rgba(29,180,141,0.35)] font-500 lh-6 text-center text-3 absolute right-4 bottom-4`}>
                            立即查看
                        </button>  
