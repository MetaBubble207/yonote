          ...
          <div className="flex pt-6.375">
            ...
            <div className="flex">
              ...
              <div className="w-22 h-8 shrink-0 bg-#DAF9F1 b-1 b-rd-1 ml-28 mt-1">
                <button className="text-[#1DB48D] font-Abel text-3.5 font-not-italic font-400 lh-5.5 ml-4 mt-1" onClick={saveDraft}>保存草稿</button>
              </div>
              ...
              <div className="b-1 b-rd-1 w-16.25 h-8 shrink-0 fill-#FFF stroke-0.25 stroke-[#D9D9D9] mt-1 ml-1.5">
                <button className="text-[rgba(0,0,0,0.65)] font-Abel text-3.5 font-not-italic font-400 lh-5.5 ml-4 mt-1" onClick={save}>发布</button>
              </div>
            </div>
          </div>
