...
const SpecialColumn = () => {
    ...
    return <div className="min-h-screen bg-[#999999] flex justify-center items-center">
        {isScreenshot &&
            <div className={"absolute h-screen w-full flex items-center justify-center z-100"}><Loading/></div>}
        {
            pngUrl !== ""
                ...
                :
                <div ref={png} className="w-full h-124 bg-[#ffffff] mx-4">
                    {/* 顶部作者信息 */}
                    <div className="flex">
                    ...
                    <div className=" w-73 h-44.5 ml-4.5 mt-4">
                        <Image src={"/images/poster/title1.svg"} alt="title1" width={2} height={2}
