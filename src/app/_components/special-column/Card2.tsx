...
export const Card2=()=>{
    ...
    return <div className={"w-91.5% mt-20px ml-16px shrink-0 border-rd-5 border-1 border-solid border-[rgba(181,181,181,0.20)] bg-[#FFF] px-10px"} >
        {/*上方文字*/}
        <div onClick={() => router.push('/special-column/content')}>
            ...
            <p className={"text-[#666]  text-3.25 font-not-italic font-400 lh-[120%] pt-5px"}>情绪价值波动，上上签，愤怒，变化，偏执，创造
                情绪价值波动，上上签，愤怒，变化，偏执，创造 </p>
        </div>
        {/*下方图标*/}
