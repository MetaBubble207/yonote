...
export const Card2=()=>{
    ...
    return <div className={"w-91.5% mt-20px ml-16px shrink-0 border-rd-5 border-1 border-solid border-[rgba(181,181,181,0.20)] bg-[#FFF] px-10px"} onClick={() => router.push('/special-column/content')}>
        {/*上方文字*/}
