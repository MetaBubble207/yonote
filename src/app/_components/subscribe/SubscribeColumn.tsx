...
const SubscribeColumn = () => {
    return (
        <div>
            <div className="h-29.25 mt-4 flex">
                <div className="relative h-18">
                    ...
                    <div className="bottom-2 right-1 absolute">
                        <Image src={"/images/subscribe/vip.png"} alt="vip" width={12} height={12} className="w-3 h-3"></Image>
                    </div>
            ...
            <div className="h-29.25 mt-4 flex">
                <div className="relative h-18">
                    <Image src={"/images/subscribe/user2.png"} alt="user_image" width={24} height={24} className="w-11.25 h-11.25 mt-4"></Image>
                    {/* <div className="bottom-2 right-1 absolute">
                        <Image src={"/images/subscribe/vip.png"} alt="vip" width={12} height={12} className="w-3 h-3"></Image>
                    </div> */}
                    <div className="text-center text-[#999]  font-500 lh-9.6">芋圆</div>
