...
const Page = () => {
    ...
    return (
        <Suspense>
            <div className={'w-full h-full flex items-start pl-8 pt-8 rounded-2.5 bg-[#FFF]'}>
                <Suspense>
                    <Table/>
                </Suspense>
                {/*封面*/}
...
function Cover() {
    ...
    return <div className={"flex items-center ml-10 mt-50"}>
        <div>
                    <span
                        className={'text-3.5 font-not-italic font-400 lh-5.5'}>封面：</span>
        </div>
        <div>
            <div>
