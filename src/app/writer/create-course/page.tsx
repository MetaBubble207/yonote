...
const Page =()=>{
    return <div className="relative w-286.75 h-195 border-rd-[0px_0px_10px_10px] bg-[#FFF] ml-16px mt-18px pt-25.75" >
        ...
        <div className="flex items-center w-full h-8 mt-6 ">
            ...
            <div className="inline items-ceter w-117 h-8 border-rd-1 border-2 border-solid mt-78 mb-78">
                <input type="" name="" id="" placeholder="起个名字" className=" outline-none text-[rgba(0,0,0,0.25)] text-3.5 font-400 lh-5.5 w-110 ml-3" ></input>
            </div>          
        </div>
        ...
        <div className="flex items-center w-full h-8 mt-6">      
            ...
            <div className="flex items-ceter w-117 h-8 border-rd-1 border-2 border-solid mt-78 mb-78">
                <input type="" name="" id="" placeholder="请输入你的专属ID" className="justify-center outline-none text-[rgba(0,0,0,0.25)] text-3.5 font-400 lh-5.5 w-110 ml-3" ></input>
            </div> 
        </div>
        <div className="flex">
