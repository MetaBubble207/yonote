...
const Page: React.FC = () => {
    ...
    return (
        <Suspense>
            <div className="relative mt-16px ml-18px w-97%">
                <div className="pt-8 w-full h-203.5 border-rd-[10px_10px_10px_10px] bg-[#FFF] ">
                    <div className="ml-8.5 text-[#323232] text-4 font-700 lh-6">共创会员</div>

                    <div className="flex mt-8.25 w-full h-8 items-center">
                        <div
                            className=" ml-8.5 flex justify-center items-center w-8 h-8 border-rd-1 bg-[rgba(69,225,184,0.20)] text-[#1DB48D] text-3.5 font-400 lh-5.5">{day}</div>
                        <div className="ml-1 w-1.442 text-[#1DB48D] text-3.5 font-400 lh-5.5">:</div>
                        <div
                            className=" ml-1 flex justify-center items-center w-8 h-8 border-rd-1 bg-[rgba(69,225,184,0.20)] text-[#1DB48D] text-3.5 font-400 lh-5.5">{hour}</div>
                        <div className="ml-1 w-1.442 text-[#1DB48D] text-3.5 font-400 lh-5.5">:</div>
                        <div
                            className=" ml-1 flex justify-center items-center w-8 h-8 border-rd-1 bg-[rgba(69,225,184,0.20)] text-[#1DB48D] text-3.5 font-400 lh-5.5">{minute}</div>
                        <div
                            className="ml-2.7 flex justify-center items-center text-[rgba(0,0,0,0.65)] font-Abel text-3.5 font-400 lh-5.5">到期时间：2024-5-28
                            21:43:59
                        </div>
                        <Link target='_blank' href={"https://work.weixin.qq.com/kfid/kfc3048f784babcb1cc"}>
                            <div
                                className="w-14.82325 text-[#1DB48D] font-Abel text-3 font-400 lh-5.5 ml-4.5">延长权益
                            </div>
                        </Link>
                    </div>
